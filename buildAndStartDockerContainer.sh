...
# Start the container
docker run -e VIRTUAL_HOST=mnrangers.unsignedbytes.com,mnrangers.com,www.mnrangers.com --name mnrangerswebsite -P -d unsignedbytes/mn-rangerswebsite-express 
